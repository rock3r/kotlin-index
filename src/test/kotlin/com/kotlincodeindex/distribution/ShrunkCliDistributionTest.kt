...
class ShrunkCliDistributionTest {
    ...
    fun `shrunk jar preserves the complete cli workload`() {
        val shrunkJar = requiredJar("kotlinCodeIndex.shrunkJar")
        val unshrunkJar = requiredJar("kotlinCodeIndex.unshrunkJar")
        ...
        assertContains(help.stdout, "Usage: kotlin-code-index")
        ...
        val indexRoot = workspace.resolve(".kotlin-index/index/$commit")
